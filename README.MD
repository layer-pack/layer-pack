...
- Node builds hardwrite the node_modules directories locations in the build, that's said for node production builds it's simplier to pack most of the npm modules
